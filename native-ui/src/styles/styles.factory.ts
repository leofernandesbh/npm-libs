...
export function makeBaseViewStyle(props: CustomViewProps): StyleProp<ViewStyle> {
  return {
    ...
    borderTopLeftRadius: props.bLeftRounded ? convertBorderRadius(props.bLeftRounded) : undefined,
    borderBottomLeftRadius: props.bLeftRounded ? convertBorderRadius(props.bLeftRounded) : undefined,
    borderTopRightRadius: props.bRightRounded ? convertBorderRadius(props.bRightRounded) : undefined,
    borderBottomRightRadius: props.bRightRounded ? convertBorderRadius(props.bRightRounded) : undefined,
